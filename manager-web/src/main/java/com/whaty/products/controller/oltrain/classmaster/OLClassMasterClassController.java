package com.whaty.products.controller.oltrain.classmaster;
...
@Lazy
@RestController
@RequestMapping("/entity/olClassMaster/olClassMasterClass")
public class OLClassMasterClassController {

    @Resource(name = "olClassMasterClassService")
    private OLClassMasterClassService olClassMasterClassService;
    ...
    public ResultDataModel getClassInfo(@PathVariable String classId) {
        Map<String, Object> classInfo = this.olClassMasterClassService.getClassInfo(classId);
    ...
    public ResultDataModel getClassDetail(@PathVariable String classId) {
        return ResultDataModel.handleSuccessResult(this.olClassMasterClassService.getClassDetail(classId));
    }
    ...
    public ResultDataModel listOnlineCourses(@PathVariable String classId) {
        return ResultDataModel.handleSuccessResult(this.olClassMasterClassService.listOnlineCourses(classId));
    }
    ...
    public ResultDataModel saveContent(@RequestBody ParamsDataModel paramsDataModel) {
        ...
        this.olClassMasterClassService.saveContent(classId, code, content);
