...
@Lazy
@RestController
@RequestMapping("/entity/training/societyTrainingItemCheck")
public class SocietyTrainingItemCheckController extends TycjGridBaseControllerAdapter<TrainingItem> {
    ...
    public GridService<TrainingItem> getGridService() {
        return this.societyTrainingItemCheckService;
    }
}
