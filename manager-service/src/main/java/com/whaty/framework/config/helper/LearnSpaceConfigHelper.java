...
@Component("learnSpaceConfigHelper")
public class LearnSpaceConfigHelper extends AbstractVersionConfigHelper<LearnSpaceConfig> {
    ...
    private static final String CACHE_KEY = "basicCache::learnSpace";

    @Override
    public void loadConfig() {
        BasicApplicationContext.LEARN_SPACE_CONFIG_MAP = this.listConfigs();
    }
    ...
    @Override
    public Class<LearnSpaceConfig> getConfigClass() {
        return LearnSpaceConfig.class;
    }
