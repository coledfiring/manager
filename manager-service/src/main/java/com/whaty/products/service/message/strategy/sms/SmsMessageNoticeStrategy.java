package com.whaty.products.service.message.strategy.sms;
 ...
 */
@Lazy
@Component("smsMessageNoticeStrategy")
public class SmsMessageNoticeStrategy implements AbstractNoticeStrategy {
    ...
    public void notice(Map<String, Object> params) throws Exception {
        ...
        Map<String, Object> messageConfig = this.getSmsConfig((String) params
        ...
        if (CollectionUtils.isEmpty(receive)) {
            throw new ServiceException("选择的用户都未填写手机号");
        }
     ...
     * @return
     */
    private Map<String, Object> getSmsConfig(String templateCode, String siteCode) {
        ...
        sql.append(" FROM                                                                   ");
        sql.append(" 	sms_message_site s                                                  ");
        sql.append(" INNER JOIN sms_message_group g ON g.id = s.fk_sms_message_group_id     ");
