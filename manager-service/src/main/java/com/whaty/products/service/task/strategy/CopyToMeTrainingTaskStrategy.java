 ...
 */
@Lazy
@Component("copyToMeTrainingTaskStrategy")
public class CopyToMeTrainingTaskStrategy extends AbstractTrainingTaskStrategy {
    ...
    public Map<String, Object> listTrainingTask(String priorityLevel, String taskType, String taskStatus, String search,
        ...
        sql.append("    WHERE                                                            ");
        sql.append("      tmt.copy_persons like '%" + managerId + "%'                    ");
