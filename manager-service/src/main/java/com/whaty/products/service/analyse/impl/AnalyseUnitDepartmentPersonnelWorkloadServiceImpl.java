 ...
 */
@Lazy
@Service("analyseUnitDepartmentPersonnelWorkloadService")
public class AnalyseUnitDepartmentPersonnelWorkloadServiceImpl extends AbstractAnalyseGridService {
