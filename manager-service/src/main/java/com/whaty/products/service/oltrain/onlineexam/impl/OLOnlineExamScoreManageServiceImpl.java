 ...
 */
@Lazy
@Service("olOnlineExamScoreManageService")
public class OLOnlineExamScoreManageServiceImpl extends TycjGridServiceAdapter<OlStudentOnlineExamScore> {
    ...
    public int doPublishStudentScore(String ids) {
        ...
        sql.append(" update ol_student_online_exam_score sc                                ");
    ...
    private void checkSelectData(String ids) {
        ...
        sql.append("   1                                                ");
        sql.append(" from                                               ");
        sql.append("   ol_student_online_exam_score                     ");
        sql.append(" where                                              ");
