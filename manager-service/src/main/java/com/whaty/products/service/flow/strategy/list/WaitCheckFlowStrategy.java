 ...
 */
@Lazy
@Component("waitCheckFlowStrategy")
public class WaitCheckFlowStrategy extends AbstractCheckFlowListStrategy {
    ...
    public Map<String, Object> listCheckFlow(String checkStatus, String needCheck, String flowType, String search,
        ...
        page = this.countPage(page, this.generalDao
                .<BigInteger>getOneBySQL(ScopeHandleUtils.handleScopeSignOfSql(sql.toString(),
        ...
        resultMap.put("checkFlow", this.generalDao.getMapBySQL(ScopeHandleUtils.handleScopeSignOfSql(sql.toString(),
