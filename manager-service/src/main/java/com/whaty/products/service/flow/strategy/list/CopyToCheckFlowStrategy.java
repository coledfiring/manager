 ...
 */
@Lazy
@Component("copyToCheckFlowStrategy")
public class CopyToCheckFlowStrategy extends AbstractCheckFlowListStrategy {
    ...
    public Map<String, Object> listCheckFlow(String checkStatus, String needCheck, String flowType, String search,
        ...
        sql.append(" AND cf.copy_persons like '%" + UserUtils.getCurrentManager().getId() + "%' ");
