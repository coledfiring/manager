 ...
 */
@Lazy
@Service("enrollColumnRegulationService")
public class EnrollColumnRegulationServiceImpl extends TycjGridServiceAdapter<EnrollColumnRegulation> {
    ...
    public void doSetToDefault(String ids) {
        ...
        this.generalDao.executeBySQL("update enroll_column_regulation set flag_is_default = ? where site_code = ?",
                noDefault.getId(), SiteUtil.getSiteCode());
        this.generalDao.executeBySQL("update enroll_column_regulation set flag_is_default = ? where id = ?",
                isDefault.getId(), ids);
    }

    @Override
    public void checkBeforeAdd(EnrollColumnRegulation bean) throws EntityException {
    ...
    @Override
    public void checkBeforeUpdate(EnrollColumnRegulation bean) throws EntityException {
    ...
    public void checkBeforeDelete(List idList) throws EntityException {
        if (this.generalDao.checkNotEmpty("select from enroll_column_regulation reg " +
