 ...
 * @author weipengsen
 */
public class TycjParameterAssert {
    ...
    public static void validatePass(Object param) {
        predicateOrigin(e -> !ValidateUtils.checkPassConstraintValidate(e)
                || (param instanceof Verifiable && !((Verifiable) param).verify()), param);
    }
}
